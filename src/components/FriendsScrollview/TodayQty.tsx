...
const TodayQty = ({ smashes = [], index, isCurrentUser = false, smashStore, setStoriesForUser, player, me = false }) => {



  const todayQty = isCurrentUser ? smashStore.todayActivity?.smashes?.length || [] : smashes.length || 0;
   ...
   console.log('render TodayQty',player?.name,prevTodayQty,todayQty)
