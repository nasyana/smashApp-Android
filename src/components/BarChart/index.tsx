...
class BarChart extends React.PureComponent {
   render() {
      const { smashStore, showVerticalAxis, goToDailyDetail = () => null } = this.props;
      const { last7Days, last7DaysShort, kFormatter, currentUser } = smashStore;
      let data = [
                  ...
                  events={[
                     {
                        ...
                        eventHandlers: {
                           onPressIn: (event, datum) => {
                              goToDailyDetail(datum.datum.dayKey)
                           }
                        }
                     }
                  ]}
...
export default inject("smashStore", "challengesStore")(observer(BarChart));
