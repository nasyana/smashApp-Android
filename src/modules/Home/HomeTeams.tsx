...
const HomeTeams = ({ smashStore, challengesStore, teamsStore }) => {
...
export default inject('smashStore', 'challengesStore', 'teamsStore')(observer(HomeTeams));