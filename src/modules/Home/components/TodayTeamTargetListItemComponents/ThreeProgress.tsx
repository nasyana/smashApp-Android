...
const ThreeProgressCircles = (props) => {
   ...
   const { kFormatter, checkInfinity, setHomeTabsIndex } = smashStore;
   ...
   return (
      <View row centerV spread>
         <TouchableOpacity
            ...
            <AnimatedView style={{ marginRight: 4 }}>
               {/* <CircularProgressBar
                  justToday={justToday}
                  size={circleSize - 10}
                  circle={false}
               ...
               /> */}
               <Text teamToday>{teamTodayProgress}%</Text>
               {teamTodayProgress >= 100 && (
                  <LottieAnimation
                     autoPlay
                     loop={false}
         ...
         <AnimatedView style={{ marginRight: 6 }}>
            <TouchableOpacity onPress={goToMeToday}>
               ...
               /> */}
               <Text meToday>{myTodayProgress}%</Text>
            </TouchableOpacity>
         ...
         {true && (
            <AnimatedView>
               <TouchableOpacity onPress={goToTeamWeek}>
                  ...
                  /> */}
                  <Text buttonLink>{teamWeekProgress}%</Text>
               </TouchableOpacity>
               {teamWeekProgress >= 100 && (
                  <LottieAnimation
                     autoPlay
