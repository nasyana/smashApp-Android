...
const EnterTeamCodeButton = ({ smashStore, teamsStore, boxed = false, hideOnHome = false, top = 16 }) => {
    ...
    const goToTeamCodeScreen = () => {
        navigate(Routes.GoalCodeScreen);
    };
        ...
        return (<Box style={{ marginHorizontal: 16, marginTop: top }}>
            <View padding-24>
                <View paddingB-16 paddingH-16>
                    <Text M18 center marginB-8>{'Enter Goal Code'}</Text>
                    <Text R14 center>{'If you have been invited by a friend, you can enter the goal code here.'}</Text>
                </View>
                <ButtonLinearWithIcon
                    title={'Enter Goal Code'}
                    bordered
