...
const Likes = (props) => {
  ...
  const data = notificatonStore.notifications.filter(item => item.type==="like")
      ...
      <FlatList
        renderItem={({ item, index }) => {
          return (
            ...
            >
              <SmartImage uri={item?.causeUserPicture?.uri} preview={item?.causeUserPicture?.preview} 
...
export default inject("notificatonStore")(observer(Likes));
