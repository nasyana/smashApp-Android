...
const Followers = (props) => {
  ...
  const renderItem = ({ item, index, }) => {
    ...
    return (
      <Follower item={item} index={index} {...{ currentUser, challengesStore, smashStore, like, kFormatter }} />
    );
  }
...
export default inject("challengesStore", "smashStore")(observer(Followers));
