...
import ChallengePlayersImFollowingScrollView from '../ChallengePlayersImFollowingScrollView'
...
class TabControllerScreen extends Component<{}, State> {
    ...
    renderTabPages() {
        ...
        const { showFollowingList, challengeData, arenaIndex, smashStore, challengesStore, goToProfile, challengeIsSingleActivity, challenge, showPlayerSmashesFunc,playerChallengeDoc } = this.props;
        return (
            <Container {...containerProps}>

                <TabController.TabPage index={0}>
                    {/* <CommunityList following /> */}
                    <ChallengePlayersImFollowingScrollView  {...{  challenge }} />
                </TabController.TabPage>
                <TabController.TabPage index={1}>
                {/* <CommunityList community  /> */}
                <ChallengePlayersImFollowingScrollView community  {...{  challenge }} />
                    {/* <PlayersImFollowing   {...{ showFollowingList, challengeData, arenaIndex, smashStore, challengesStore, goToProfile, challengeIsSingleActivity, challenge, showPlayerSmashesFunc }} /> */}
                </TabController.TabPage>
