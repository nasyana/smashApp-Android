        ...
        return (
            <Container {...containerProps}>
                ...
                <TabController.TabPage index={0}>
                    <CommunityList {...{ arenaIndex, challengeData, smashStore, challengesStore, goToProfile, challengeIsSingleActivity, challenge, showPlayerSmashesFunc,playerChallengeDoc }} />
