...
const ChallengesBreakdownList = (props) => {
   ...
   const challengesWithActivity = Object.values(day.challenges)?.filter(
      (challenge) => challenge.masterIds?.includes(activity.masterId),
   );

   const DATA = day?.challenges
      ? Object.keys(day?.challenges).map((chId) => {
...
export default inject(
   ...
   'challengesStore',
   'challengeArenaStore',
)(observer(ChallengesBreakdownList));
